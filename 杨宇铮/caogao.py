                ...
                try:
                    ...
                    if checkyear < 2000:
                        ...
                        while True:
                            try:
                                name = \
                                driver.find_elements_by_xpath('//*[@id="table_main"]/tbody/tr[' + str(i) + ']/td[1]')[
                                    0].text
                                # print(name)
...
def run(each,initlist,copylist):
...
if __name__=="__main__":
    ...
    for each in range(1, len(copylist)):
        initlist,copylist=run(each,initlist,copylist)
    driver.close()
