...
# n_job_id = [1, 9, 8, 2, 0, 3, 6, 9, 9, 0, 6, 3, 7, 1, 5, 8, 4, 8, 2, 1, 1, 8, 9, 6, 8, 5, 8, 3, 2, 0, 6, 7, 4, 0, 2, 1, 7, 0, 3, 9, 4, 7, 5, 9, 5, 2, 3, 4, 4, 7, 5, 4, 0, 6, 5]
...
def draw_fjssp_gantt():
    fig = draw_prepare()
    add_annotations(fig)
    py.offline.plot(fig, filename='../车间调度问题甘特图/fjssp-gantt-picture.html')
